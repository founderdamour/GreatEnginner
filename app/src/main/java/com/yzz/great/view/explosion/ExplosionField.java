...
import com.yzz.great.util.BitmapUtils;
...
public class ExplosionField extends View {
    ...
    public ExplosionField(Context context, ParticleFactory particleFactory) {
        this(context, null, particleFactory);
    }

    public ExplosionField(Context context, @Nullable AttributeSet attrs, ParticleFactory particleFactory) {
        this(context, attrs, 0, particleFactory);
    }

    public ExplosionField(Context context, @Nullable AttributeSet attrs, int defStyleAttr, ParticleFactory particleFactory) {
