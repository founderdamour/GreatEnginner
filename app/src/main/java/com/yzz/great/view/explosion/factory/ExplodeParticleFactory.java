...
import com.yzz.great.view.explosion.particle.ExplodeParticle;
...
public class ExplodeParticleFactory extends ParticleFactory{
    ...
    public static final float X = CommonUtils.dp2Px(5);
    public static final float Y = CommonUtils.dp2Px(20);
    public static final float V = CommonUtils.dp2Px(2);
    public static final float W = CommonUtils.dp2Px(1);
